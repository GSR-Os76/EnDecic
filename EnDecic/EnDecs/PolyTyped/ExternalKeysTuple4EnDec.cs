...
{
    public sealed class ExternallyKeyedTuple4EnDec<TKey, T1, T2, T3, T4> : IEnDec<Tuple<T1?, T2?, T3?, T4?>>
    {
        ...
        public ExternallyKeyedTuple4EnDec(IEnDec<TKey> keyEnDec,
        ...
        public U Encode<U>(IEncodingSet<U> codingSet, Tuple<T1?, T2?, T3?, T4?> data) => _enDec.Encode(codingSet, new ImmutableOrderedDictionary<TKey, object?>(
