...
{
    public sealed class ExternallyKeyedTuple5EnDec<TKey, T1, T2, T3, T4, T5> : IEnDec<Tuple<T1?, T2?, T3?, T4?, T5?>>
    {
        ...
        public ExternallyKeyedTuple5EnDec(IEnDec<TKey> keyEnDec,
        ...
        public U Encode<U>(IEncodingSet<U> codingSet, Tuple<T1?, T2?, T3?, T4?, T5?> data) => _enDec.Encode(codingSet, new ImmutableOrderedDictionary<TKey, object?>(
