...
#warning test these below
        public static readonly IEnDec<IOrderedDictionary<string, string>> TYPE_A_STRING_STRING_FIXED_KEY_MAP = EnDecs.STRING.FixedKeyMapOf(EnDecs.STRING, new string[] { "type", "a" });
        public static readonly IEnDec<IOrderedDictionary<string, string>> TYPE_A_STRING_STRING_IMPLIED_KEY_MAP = EnDecs.STRING.ImpliedKeysMapOf(new string[] { "type", "a" });
